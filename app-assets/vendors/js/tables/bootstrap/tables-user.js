 ...
 userDocRef.get().then(function (querySnapshot) {
     querySnapshot.forEach(function (doc) {
         ...
         $('.table-user-list')[0].innerHTML += '<tr class="' + doc.id + '"><td><img src="../../../app-assets/images/icons/user.svg" class="mr-75" height="20" width="20" alt="Angular" /><span class="font-weight-bold">' + doc.data().Name + '</span></td><td>' + doc.data().Email + '</td><td>' + doc.data().Role + '</td><td><span class="badge badge-pill badge-light-' + chipColor + ' mr-1">' + doc.data().Status + '</span></td><td><div class="dropdown"><button type="button" class="btn btn-sm dropdown-toggle hide-arrow" data-toggle="dropdown"><i data-feather="more-vertical"></i></button><div class="dropdown-menu"><a class="dropdown-item dropdown-edit"><i data-feather="edit-2" class="mr-50"></i><span>Edit</span></a><a class="dropdown-item" href="javascript:void(0);"><i data-feather="trash" class="mr-50"></i><span>Delete</span></a></div></div></td></tr>';
     })
     feather.replace();
     $.holdReady(false);
 })
