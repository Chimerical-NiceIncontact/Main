        ...
        if (user) {
            db.collection("users").doc(user.uid).get().then(function (doc) {
                if (doc.exists) {
                    ...
                    $('.user-username')[0].innerHTML = data.Username;
                    $('.user-status')[1].innerHTML = data.Status;
                    $('.user-role')[0].innerHTML = data.Role;
                    $('.user-phone')[0].innerHTML = data.Phone;
                    // Agent Id Info
                    $('.user-c35')[0].innerHTML = data.AgentID.C35;
                    $('.user-c32')[0].innerHTML = data.AgentID.C32;
